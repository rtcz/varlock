...
class TestBamMutator(unittest.TestCase):
    ...
    def test_unmutate_01(self):
        ...
        mut.unmutate(
            ...
            diff_file=self.UNMUT_DIR_PATH + 'input_01.diff',
        ...
        self.assertEqual(True, filecmp.cmp(self.UNMUT_DIR_PATH + 'desired.sam', self.UNMUT_DIR_PATH + 'output_01.sam'))
    ...
    def test_unmutate_02(self):
        ...
        mut.unmutate(
            ...
            diff_file=self.UNMUT_DIR_PATH + 'input_02.diff',
        ...
        self.assertEqual(True, filecmp.cmp(self.UNMUT_DIR_PATH + 'desired.sam', self.UNMUT_DIR_PATH + 'output_02.sam'))
    ...
    def test_unmutate_03(self):
        ...
        self.assertEqual(True,
                         filecmp.cmp(self.UNMUT_DIR_PATH + 'desired_03.sam', self.UNMUT_DIR_PATH + 'output_03.sam'))
        
        # TODO more slicing tests
        # TODO test case with more references (chromosomes)
