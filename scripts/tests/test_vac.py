...
class TestVac(unittest.TestCase):
    ...
    def __build_vac_file(cls):
        ...
        Vac.write_snv_record(vac_file, 2000000000, (3, 2, 1, 0))
        Vac.write_snv_record(vac_file, 2000000002, (0, 1, 2, 3))
        Vac.write_snv_record(vac_file, 2000000004, (1, 1, 1, 1))
        Vac.write_indel_record(vac_file, 2000000001, [(10, 'A'), (1, 'ATCG')])
        Vac.write_indel_record(vac_file, 2000000003, [(10, 'AT'), (1, 'ATCGT')])
        Vac.write_indel_record(vac_file, 2000000005, [(10, 'AAAA'), (10, 'ATCG'), (0, 'A')])
        vac_file.seek(0)
        return vac_file
