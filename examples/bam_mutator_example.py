...
import varlock.bam_mutator as bammut
...
mut = bammut.BamMutator(bam_filename, rnd=random.Random(0), verbose=True)
with io.BytesIO() as diff_file:
    mut.mutate(vac_filename, mut_bam_filename, diff_file)
